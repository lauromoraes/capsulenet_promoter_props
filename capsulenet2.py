...
def CapsNet(input_shape, n_class, routings):
    ...
    conv1 = layers.Conv2D(filters=256, kernel_size=(38,9), strides=1, padding='valid', activation='relu', name='conv1')(x)
...
def train(model, data, args):
    ...
    reducelr = callbacks.ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=3, min_lr=0.0001)
